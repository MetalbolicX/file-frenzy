...
<div align="center">
  <img src="./images/logo.png" alt="file-frenzy Logo" width="200" height="200" />
</div>

> `file-frenzy` small slogan.
...
```json
{
  "bs-dependencies": ["file-frenzy"]
}
```

## 🙌 Hello World Example

Here's a simple example of how to use `file-frenzy` to create a reactive UI component:
...
To build and run your ReScript application, see the [Compile and Run](https://metalbolicx.github.io/file-frenzy/#/compile-run) section.

## 📚 Documentation

<div align="center">

  [![view - Documentation](https://img.shields.io/badge/view-Documentation-blue?style=for-the-badge)](https://metalbolicx.github.io/file-frenzy/#/api-reference)
